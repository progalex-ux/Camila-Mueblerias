...
function returnsa(){
    window.location.href = base_url+"index.php/admin/cardsSalas";
}
function loadImage() {
  ...
  function enviarDatos(jsonTarjeta) {
      $.ajax({
          url: base_url+"index.php/tarjetas/saveCardSalamodular",
          dataType: "json",
          type: "post",
          data: jsonTarjeta,
          contentType: false,
  ...
  reloadCardSalamodular();
  
  function reloadCardSalamodular() {
      $.ajax({
          url: base_url + "index.php/tarjetas/getCardSalamodular",
          dataType: "json",
          type: "post",
          data: {},
          success: function (datos, estado, jhrx) {
