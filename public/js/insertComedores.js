...
function returnc(){
    window.location.href = base_url+"index.php/admin/cardsCocinas";
}
function loadImage() {
  ...
  function enviarDatos(jsonTarjeta) {
      $.ajax({
          url: base_url+"index.php/tarjetas/saveCardComedores",
          dataType: "json",
          type: "post",
          data: jsonTarjeta,
          contentType: false,
  ...
  function reloadCardComedores() {
      $.ajax({
          url: base_url + "index.php/tarjetas/getCardComedores",
          dataType: "json",
          type: "post",
          data: {},
          success: function (datos, estado, jhrx) {
