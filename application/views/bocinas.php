...
<head>
    ...
    <title>Bocinas | Electronica | Camila Mueblerias</title>
...
<nav id="sticky-header" class="position-relative d-flex justify-content-around"
            ...
            <div class="categorias" style="width:44%;">
                <div class="menu position-relative d-inline-block">
                    ...
                    <div class="menu-content z-3 position-absolute justify-content-center rounded-start" id="myDropdown">
                        ...
                        <a href="<?= base_url() ?>index.php/principal/salas">Recamaras</a>
    ...
    <main class="d-flex justify-content-start aling-middle">
        <aside class="sidebar d-none d-lg-block">
            ...
            <i class="bi bi-dash-circle fs-6 pt-4"></i>&nbsp<h6 class="pt-4"><a href="<?= base_url() ?>index.php/principal/electronica" class="text-decoration-underline" style="color:black; text">Electronica</a>/ <a href="<?= base_url() ?>index.php/secciones/bocinas" class="text-decoration-underline" style="color:black;">Bocinas</a></h6>
            </div>
