...
<nav id="sticky-header" class="position-relative d-flex justify-content-around"
    ...
    <main class="d-flex justify-content-start aling-middle">
        <aside class="sidebar d-none d-lg-block">
            ...
            <i class="bi bi-dash-circle fs-6 pt-4"></i>&nbsp<h6 class="pt-4"><a href="<?= base_url() ?>index.php/principal/salas" class="text-decoration-underline" style="color:black; text">Salas</a>/ <a href="<?= base_url() ?>index.php/secciones/salamodular" class="text-decoration-underline" style="color:black;">Salas modulares</a></h6>
            </div>
