...
<head>
    ...
    <title>Sillas | Cocinas | Camila Mueblerias</title>
...
<nav id="sticky-header" class="position-relative d-flex justify-content-around"
    ...
    <main class="d-flex justify-content-start aling-middle">
        <aside class="sidebar d-none d-lg-block">
            ...
            <i class="bi bi-dash-circle fs-6 pt-4"></i>&nbsp<h6 class="pt-4"><a href="<?= base_url() ?>index.php/principal/cocinas" class="text-decoration-underline" style="color:black; text">Cocinas</a>/ <a href="<?= base_url() ?>index.php/secciones/sillas" class="text-decoration-underline" style="color:black;">Sillas</a></h6>
            </div>
            <div class="categorias-tecno d-flex justify-content-start" style="width:100%; height:15%;">
                <ul class="d-flex flex-column ">
                    ...
                    <a class="pt-1 ps-1" style="font-size:14px;" href="<?= base_url() ?>index.php/secciones/vitrinas">Vitrinas</a>
                </ul>
            </div>
        </aside>
        <section>
    ...
    <script src="<?= base_url() ?>public/js/insertSillas.js"></script>
