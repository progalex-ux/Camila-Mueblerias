...
<head>
    ...
    <title>Electrodomesticos | Camila Mueblerias</title>
</head>
        ...
        <section class="">
            <div id="hero-carousel" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active c-item" data-bs-interval="5000">
                        <img src="<?= base_url() ?>public/img/electrodomesticos/electro.jpg"
            ...
            <div class="sellos d-flex justify-content-center " style="background-color:#F2F3F4;">
                ...
                <div class="sello ms-5 rounded-5"><a href="<?= base_url() ?>index.php/secciones/licuadoras"><img src="<?= base_url() ?>public/img/electrodomesticos/licuadora.png"
                        alt=""></a></div>
                <div class="sello ms-5 rounded-5"><a href="<?= base_url() ?>index.php/secciones/parrillas"><img src="<?= base_url() ?>public/img/electrodomesticos/parrilla.png"
                        alt=""></a></div>
                <div class="sello ms-5 rounded-5"><a href="<?= base_url() ?>index.php/secciones/secadoras"><img src="<?= base_url() ?>public/img/electrodomesticos/secadora.png"
                        alt=""></a></div>
                <div class="sello ms-5 rounded-5"><a href="<?= base_url() ?>index.php/secciones/lavadoras"><img src="<?= base_url() ?>public/img/electrodomesticos/lavadora.png"
                        alt=""></a></div>
            </div>
