...
<head>
    ...
    <title>Estufas | Electrodomesticos | Camila Mueblerias</title>
...
<nav id="sticky-header" class="d-flex justify-content-around"
    ...
    <main class="d-flex justify-content-start aling-middle">
        <aside class="sidebar d-none d-lg-block">
            ...
            <i class="bi bi-dash-circle fs-6 pt-4"></i>&nbsp<h6 class="pt-4"><a href="<?= base_url() ?>index.php/principal/electrodomesticos" class="text-decoration-underline" style="color:black; text">Electrodomesticos</a> / <a href="<?= base_url() ?>index.php/secciones/estufas" class="text-decoration-underline" style="color:black;">Estufas</a></h6>
            </div>
