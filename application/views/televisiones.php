...
<head>
    ...
    <title>Televisiones | Electronica | Camila Mueblerias</title>
...
<nav id="sticky-header" class=" d-flex justify-content-around"
    ...
    <main class="d-flex justify-content-start aling-middle">
        <aside class="sidebar d-none d-lg-block">
            ...
            <i class="bi bi-dash-circle fs-6 pt-4"></i>&nbsp<h6 class="pt-4"><a class="breadcrumb-item active" href="<?= base_url() ?>index.php/principal/electronica" class="text-decoration-underline" style="color:black; text">Electronica</a> / <a href="<?= base_url() ?>index.php/secciones/televisiones" class="text-decoration-underline" style="color:black;">Televisiones</a></h6>
            </div>
            <div class="categorias-tecno d-flex justify-content-start" style="width:100%; height:15%;">
                <ul class="d-flex flex-column ">
                    ...
                    <a class="pt-1 ps-1" style="font-size:14px;" href="<?= base_url() ?>index.php/secciones/laptop">Laptops</a>
