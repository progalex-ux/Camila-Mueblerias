...
<head>
    ...
    <title>Sofas| Salas | Camila Mueblerias</title>
...
<nav id="sticky-header" class="position-relative d-flex justify-content-around"
    ...
    <main class="d-flex justify-content-start aling-middle">
        <aside class="sidebar d-none d-lg-block">
            ...
            <i class="bi bi-dash-circle fs-6 pt-4"></i>&nbsp<h6 class="pt-4"><a href="<?= base_url() ?>index.php/principal/salas" class="text-decoration-underline" style="color:black; text">Salas</a>/ <a href="<?= base_url() ?>index.php/secciones/sofas" class="text-decoration-underline" style="color:black;">Sofas</a></h6>
            </div>
            <div class="categorias-tecno d-flex justify-content-start" style="width:100%; height:15%;">
                <ul class="d-flex flex-column ">
                    ...
                    <a class="pt-1 ps-1" style="font-size:14px;" href="<?= base_url() ?>index.php/secciones/sofacama">Sofa camas</a>
                </ul>
            </div>
        </aside>
        <section>
    ...
    <script src="<?= base_url() ?>public/js/insertSofas.js"></script>
