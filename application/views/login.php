...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url() ?>public/css/login/login.css">
...
<body style="background-image: url('<?= base_url() ?>public/img/fondo2.avif'); background-size: cover; background-repeat: no-repeat;">
    <main>
        <section>
       
            <div class="login-contenedor d-flex rounded-1" >
                <div class="login">
                    <div class="empty "><a href="<?= base_url() ?>index.php/principal/"><button class="btn btn-light border-0 mt-1" data-toggle="tooltip" data-placement="top" title="Inicio" style="background-color:transparent;"><i class="bi bi-arrow-left fs-4" style="color:white;"></i></button></a></i></div>
                    <div class="empty"></div>
                    <div class="imagen">
