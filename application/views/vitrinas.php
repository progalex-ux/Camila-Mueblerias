...
<head>
    ...
    <title>Vitrinas | Cocinas | Camila Mueblerias</title>
...
<nav id="sticky-nav" class="d-flex justify-content-around">
    ...
    <main class="d-flex justify-content-start aling-middle">
        <aside class="sidebar d-none d-lg-block">
            ...
            <i class="bi bi-dash-circle fs-6 pt-4"></i>&nbsp<h6 class="pt-4"><a href="<?= base_url() ?>index.php/principal/cocinas" class="text-decoration-underline" style="color:black; text">Cocinas</a>/ <a href="<?= base_url() ?>index.php/secciones/vitrinas" class="text-decoration-underline" style="color:black;">Vitrinas</a></h6>
            </div>
    ...
    <script src="<?= base_url() ?>public/js/insertVitrinas.js"></script>
