...
<head>
    ...
    <title>Telefonos | Electronica | Camila Mueblerias</title>
...
<body>
    ...
    <main class="d-flex justify-content-start aling-middle">
        <aside class="sidebar d-none d-lg-block">
            ...
            <i class="bi bi-dash-circle fs-6 pt-4"></i>&nbsp<h6 class="pt-4"><a href="<?= base_url() ?>index.php/principal/electronica" class="text-decoration-underline" style="color:black; text">Electronica</a>/ <a href="<?= base_url() ?>index.php/secciones/telefonos" class="text-decoration-underline" style="color:black;">Telefonos</a></h6>
            </div>
    ...
    <script src="<?= base_url() ?>public/js/insertTelefonos.js"></script>
