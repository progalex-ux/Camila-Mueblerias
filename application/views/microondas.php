...
<nav id="sticky-header" class="position-relative d-flex justify-content-around"
    ...
    <main class="d-flex justify-content-start aling-middle">
        ...
        <div class="sidebar-tittle d-flex ps-2 ">
            <i class="bi bi-dash-circle fs-6 pt-4"></i>&nbsp<h6 class="pt-4"><a href="<?= base_url() ?>index.php/principal/electrodomesticos" class="text-decoration-underline" style="color:black; text">Electrodomesticos</a> / <a href="<?= base_url() ?>index.php/secciones/microondas" class="text-decoration-underline" style="color:black;">Microondas</a></h6>
            </div>
