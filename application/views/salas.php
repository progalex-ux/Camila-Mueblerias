                                    ...
                                    <ul class="collapse nav flex-column ms-1" id="submenu3" data-bs-parent="#menu">
                                        <li>
                                            <a href="" class="nav-link px-0"> <span
                                                    class="d-none d-sm-inline"><i class="bi bi-shop"> Entrega en Tienda</i></span> </a>
                                        </li>
                                    </ul>
                        ...
                        <div class="content">
                            <div class="row">
                                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                                    <div class="card">
                                        <img  class="zoom" src="<?= base_url() ?>public/img/motos/cuatri.jpg" alt="Imagen" >
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                                    <div class="card">
                                        <img class="zoom" src="<?= base_url() ?>public/img/motos/hondadio.jpg" alt="Imagen">
                                        <div class="custom-card-content">
                                            <h5 class="custom-card-price">$42,990</h5>
                                            <p class="custom-card-tittle">Cuatrimoto dinamo 150cc</p>
                                        </div>
