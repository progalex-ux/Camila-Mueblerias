            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                    <div class="card">
                        ...
                        <div class="custom-card-content">
                            <h5 class="custom-card-title">Colchones</h5>
                            <a href="<?= base_url() ?>index.php/admin/insertColchones/"><button type="button" class="btn btn-dark">Agregar contenido</button></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                    <div class="card">
                        ...
                        <div class="custom-card-content">
                            ...
                            <a href="<?= base_url() ?>index.php/admin/insertBasescama/"><button type="button" class="btn btn-dark">Agregar contenido</button></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                    <div class="card">
                        ...
                        <div class="custom-card-content">
                            <h5 class="custom-card-title">Burós</h5>
                            <a href="<?= base_url() ?>index.php/admin/insertBuros"><button type="button" class="btn btn-dark">Agregar contenido</button></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                    <div class="card">
                        ...
                        <div class="custom-card-content">
                            <h5 class="custom-card-title">Roperos</h5>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                    <div class="card">
                        ...
                        <div class="custom-card-content">
                            <h5 class="custom-card-title">Cabeceras</h5>
