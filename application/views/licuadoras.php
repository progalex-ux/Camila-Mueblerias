...
<head>
    ...
    <title>Licuadoras | Electrodomesticos | Camila Mueblerias</title>
...
<nav id="sticky-header" class="d-flex justify-content-around"
        ...
        <div class="secciones d-flex align-items-center text-center" style=" background-color: transparent;">
            <div class="categorias" style="width:44%;">
                <div class="menu position-relative d-inline-block">
                    ...
                    <div class="menu-content rounded-start z-3 position-absolute justify-content-center rounded" id="myDropdown">
    ...
    <main class="d-flex justify-content-start aling-middle">
        <aside class="sidebar d-none d-lg-block">
            ...
            <i class="bi bi-dash-circle fs-6 pt-4"></i>&nbsp<h6 class="pt-4"><a href="<?= base_url() ?>index.php/principal/electrodomesticos" class="text-decoration-underline" style="color:black; text">Electrodomesticos</a> / <a href="<?= base_url() ?>index.php/secciones/licuadoras" class="text-decoration-underline" style="color:black;">Licuadoras</a></h6>
            </div>
            <div class="categorias-tecno d-flex justify-content-start" style="width:100%; height:15%;">
                <ul class="d-flex flex-column ">
                    ...
                    <a class="pt-1 ps-1" style="font-size:14px;" href="<?= base_url() ?>index.php/secciones/refrigerador">Refrigerador</a>
                </ul>
            </div>
        </aside>
        <section>
