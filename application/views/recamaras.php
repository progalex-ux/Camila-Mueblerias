...
<body>
    ...
    <nav class="navbar navbar-white" id="sticky-nav">
        <div class="container-fluid">
            <div class="menu">
                <button  type="button" data-bs-toggle="offcanvas" data-bs-target="#menuLateral">
        ...
        <div class="content">
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="card">
                        <img src="<?= base_url() ?>public/img/recamaras/colchon.jpg" alt="Imagen">
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="card">
                        <img src="<?= base_url() ?>public/img/recamaras/base-matri.jpg" alt="Imagen">
                        <div class="custom-card-content">
                            <h5 class="custom-card-price">$42,990</h5>
