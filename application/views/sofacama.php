...
<nav id="sticky-header" class="position-relative d-flex justify-content-around"
            ...
            <div class="categorias" style="width:44%;">
                <div class="menu position-relative d-inline-block">
                    ...
                    <div class="menu-content z-3 position-absolute justify-content-center rounded-start" id="myDropdown">
                        ...
                        <div class="subdropdown rounded-start" id="subdropdown-cocinas">
                            <div class="seccion-1">
                        ...
                        <div class="subdropdown rounded-start" id="subdropdown-salas">
                            <div class="seccion-1">
                        ...
                        <div class="subdropdown rounded-start" id="subdropdown-electrodomesticos">
                            <div class="seccion-1">
                        ...
                        <div class="subdropdown rounded-start" id="subdropdown-electronica">
                            <div class="seccion-1">
    ...
    <script src="<?= base_url() ?>public/js/insertSofacama.js"></script>
