...
<head>
    ...
    <title>Sofa camas| Salas | Camila Mueblerias</title>
...
<nav id="sticky-header" class="d-flex justify-content-around"
            ...
            <div class="categorias" style="width:44%;">
                <div class="menu position-relative d-inline-block">
                    ...
                    <div class="menu-content z-3 position-absolute justify-content-center rounded" id="myDropdown">
                        ...
                        <div class="subdropdown rounded-start z-3 position-absolute" id="subdropdown-recamaras">
                            <div class="seccion-1">
                        ...
                        <div class="subdropdown rounded-start position-absolute" id="subdropdown-cocinas">
                            <div class="seccion-1">
                        ...
                        <div class="subdropdown rounded-start position-absolute" id="subdropdown-salas">
                            <div class="seccion-1">
                        ...
                        <div class="subdropdown rounded-start position-absolute" id="subdropdown-electrodomesticos">
                            <div class="seccion-1">
                        ...
                        <div class="subdropdown rounded-start position-absolute" id="subdropdown-electronica">
                            <div class="seccion-1">
    ...
    <main class="d-flex justify-content-start aling-middle">
        <aside class="sidebar d-none d-lg-block">
            ...
            <i class="bi bi-dash-circle fs-6 pt-4"></i>&nbsp<h6 class="pt-4"><a class="breadcrumb-item active" href="<?= base_url() ?>index.php/principal/salas" class="text-decoration-underline" style="color:black; text">Salas</a> / <a href="<?= base_url() ?>index.php/secciones/salamodular" class="text-decoration-underline" style="color:black;">Sofa camas</a></h6>
            </div>
            <div class="categorias-tecno d-flex justify-content-start" style="width:100%; height:15%;">
                <ul class="d-flex flex-column ">
                    <a class="pt-1 ps-1" style="font-size:14px;" href="<?= base_url() ?>index.php/secciones/salamodular">Salas modulares</a>
                    <a class="pt-1 ps-1" style="font-size:14px;" href="<?= base_url() ?>index.php/secciones/sofas">Sofas</a>
                </ul>
            </div>
        </aside>
        <section>
