        ...
        <div class="content">
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="card">
                        <img src="<?= base_url() ?>public/img/salas/sala5.png" alt="Imagen">
                        <div class="custom-card-content">
                            <h5 class="custom-card-price">$42,990</h5>
                            <p class="custom-card-tittle">Sala</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="card">
                        <img src="<?= base_url() ?>public/img/salas/salapiel2.png" alt="Imagen">
                        <div class="custom-card-content">
                            <h5 class="custom-card-price">$42,990</h5>
                            <p class="custom-card-tittle">Sala piel</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="card">
                        <img src="<?= base_url() ?>public/img/salas/sofacama1.png" alt="Imagen">
                        <div class="custom-card-content">
                            <h5 class="custom-card-price">$42,990</h5>
                            <p class="custom-card-tittle">Sofa cama</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="card">
                        <img src="<?= base_url() ?>public/img/salas/sofacamadoble2.png" alt="Imagen">
                        <div class="custom-card-content">
                            <h5 class="custom-card-price">$42,990</h5>
                            <p class="custom-card-tittle">Sofa cama</p>
                        </div>
